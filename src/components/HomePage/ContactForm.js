...
export default class ContactForm extends Component {
   submitContactForm() {
      if (
         ...
         axios
            .post(`/api/v${API_INFO.VERSION}/contact-form/submit`, {
               ...this.state
            })
            .then(({ data }) => {
         ...
         <div className="ContactForm">
            <div className="ContactForm__FormContent padding-all--md">
               ...
               <p className="margin-bottom--md">
                  Have a project you need a hand on? Drop me a line and I'll get
               ...
               {this.state.status === STATUS.SUCCESS && (
                  <SuccessBlock text="Your form has been received; thanks!" />
               )}
               {this.state.status === STATUS.ERROR && (
                  <ErrorBlock text="An error occurred, please try again later." />
               )}
               {!!this.state.inputError && (
                  <ErrorBlock text={this.state.inputError} />
               )}
               <Button.Modern
                  text="Send"
