...
export default class Recommendations extends Component {
   componentDidMount() {
      axios
         .get(
            `/api/v${API_INFO.VERSION}/recommendations/get-top-recommendations/`
         )
      ...
      return (
         <div className="Recommendations fill--light padding-top--lg padding-right--md padding-bottom--lg padding-left--md">
            <div className="Recommendations__Content">
               ...
               <SimpleSpacer.Medium />
               <p>
                  Some of my favorite reads from around the web. Check them out,
                  maybe you&apos;ll learn something new!
               </p>
               {this.state.error && <div className="error" />}
               {this.state.loading && <Loader />}
               {!this.state.loading && (
                  <div className="RecommendationsWrapper margin-top--sm">
